...
import {ArrowRight, CheckCircle, Github, Mail, Menu, NetworkIcon, X} from "lucide-react"
            ...
            <header
                ...
                <div className="container flex h-14 items-center justify-between mx-auto px-4">
                    <Link href="/" className="flex items-center space-x-2">
                        <Image src="/img/logo/black_logo.png" className={"block dark:hidden"} alt="SYIGEN Logo" width={100}
                               height={100}/>
                        <Image src="/img/logo/white_logo.png" className={"hidden dark:block"} alt="SYIGEN Logo"
            ...
            <main className="flex-1">
                ...
                <section id="contact" className="py-12 px-4 md:py-16 md:px-6 lg:py-24 lg:px-8 bg-muted">
                    <div className="container mx-auto max-w-7xl text-center">
                        <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">Transform Your Enterprise with
                            SYIGEN</h2>
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <div className="flex items-center">
                                ...
                                <Link href="https://github.com/syigen/ceylon"
